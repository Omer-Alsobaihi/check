...
function FootHtml() {
    $year = date('Y');
    echo '</main><footer><div class="wrap footer-inner"><div class="brand"><small>GOLDEN</small><b>maxi<span>+</span></b><em>PLUS</em></div><span>نظام التحقق من أصالة المنتج</span><nav><a href="#steps">طريقة التحقق</a><a href="#privacy">سياسة الخصوصية</a><a href="#terms">شروط الاستخدام</a></nav><small>© ' . $year . ' محفوظة جميع الحقوق</small></div></footer><script src="js/script.js"></script></body></html>';
}
